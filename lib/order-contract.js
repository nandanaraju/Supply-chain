...
class OrderContract extends Contract {
    ...
    async createOrder(ctx, orderId) {
        ...
        if (mspid === 'distributerMSP') {
            ...
            if (!transientData.has('type') || !transientData.has('quantity') || !transientData.has('price') || !transientData.has('market')) {
            ...
            OrderAsset.market = transientData.get('market').toString();
