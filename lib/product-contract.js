...
class ProductContract extends Contract {
    ...
    // Wholesaler updates the product status to "Transferred to Wholesaler"
    ...
    async matchOrder(ctx, productId, orderId) {
        ...
        if (orderDetails.type === productDetails.type && orderDetails.quantity <= productDetails.quantity) {
            productDetails.ownedBy = orderDetails.buyer;
            ...
            return `Product ${productId} is assigned to ${orderDetails.market}`;
        } else {
